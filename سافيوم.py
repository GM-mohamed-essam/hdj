...
my_secret = '7181242922:AAFLGMLxUs9Dj1eTMBuF1zhiytgVfZbnRTQ'
...
def Start(message):
    ...
    control.add(types.InlineKeyboardButton(' Devloper 👨🏻‍💻',url='https://t.me/B_0_R_U'),types.InlineKeyboardButton('Channel',url='https://t.me/zj_x3'))
    ...
    if call.data=='StartSafum':
        ...
        def StartSafum(call):
                ...
                if path.exists('StartSafum.txt') == True: 
                    ...
                    elif '"status":"Success"' in str(decoded_data):bot.send_message(call.message.chat.id,f'{user}')
                    Created+=1
